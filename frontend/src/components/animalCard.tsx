...
export const AnimalCard = ({ animal, onLoginRequest, isFavorited = false, onToggleFavorite }: Props) => {
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-actions">
          {/* Contact button — visible to all logged in */}
          <RoleGuard
            requireAuth
            fallback={
          ...
          {/* Heart toggle — only for logged-in users */}
